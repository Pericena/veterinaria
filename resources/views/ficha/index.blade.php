...
<tr>
        <td class="py-3 px-6 text-center">{{$fichas->id}}</td>
        <td class="py-3 px-6 text-center">{{$fichas->fecha}}</td>


        @foreach($periodo as $periodos)
       
       @if($fichas->periodo_id == $periodos->id)
       <td class="p-3 text-center">{{$periodos->inicio}} - {{$periodos->fin}}</td>
       @endif
       
       @endforeach


        <td class="py-3 px-6 text-center">{{$fichas->reserva_id}}</td>
