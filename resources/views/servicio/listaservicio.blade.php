...
<tr>
        <td class="py-3 px-6 text-center">{{$servicios->id}}</td>
        <td class="py-3 px-6 text-center">{{$servicios->nombre}}</td>
        <td class="py-3 px-6 text-center">{{$servicios->descripcion}}</td>
        <td class="py-3 px-6 text-center">{{$servicios->imagen}}</td>
