...
<table class="my-10 table-fixed w-full">
  ...
  @foreach($especie as $especies)
      <tr>
        ...
        <td class="py-3 px-6"> {{$especies->id}}</td>
        ...
        <td class="p-1 text-center">
            ...
            <a href="{{route('admin.destroyespecie', $especies->id)}}" class="text-black font-semibold border-2 border-red-500 py-3 px-8 pt-1 h-10 rounded-md hover:bg-red-500 hover:text-white">Borrar</a>
            <a href="{{route('admin.editespecie', $especies->id)}}" class="text-black font-semibold border-2 border-blue-500 py-3 px-8  pt-1 h-10 rounded-md hover:bg-blue-500 hover:text-white">Editar</a>
