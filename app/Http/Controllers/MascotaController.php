...
class MascotaController extends Controller{
    ...
    public function listamascota(){
        ...
        $raza = raza::all();
        $user = User::all();
        return view('mascota.listamascota', compact('mascota','especie','raza','user'));
   }

   public function createMascota(){
    $user = User::all();
    $raza = raza::all();
    return view('mascota.crearmascota',compact('raza','user'));
}
...
public function storedMascota(Request $request){
 ...
 public function destroyMascota($id){
    ...
    public function editMascota($id){
        ...
        $raza = raza::all();
        $user = User::all();
        return view('mascota.editarmascota',compact('mascota','raza','user'));
    }
